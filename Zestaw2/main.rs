// Przy założeniu, że mamy zdefiniowane dwie funkcje:
    // fn f(x: f64) -> f64
    // fn fp(x: f64) -> f64
// (spełniające odpowiednie założenia; druga jest pochodną pierwszej) napisz funkcję
// fn met_newt(x0: f64, eps: f64, N: u128) -> f64
// (parametry opracuj sam) realizującą znajdowanie przybliżonego miejsca zerowego metodą Newtona — w trzech wersjach:
